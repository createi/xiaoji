...
const columns = [
  ...
  { title: '砍价底价', dataIndex: 'bargainPrice', width: 120 },
  { title: '原价', dataIndex: 'originalPrice', width: 120 },
  { title: '最低砍价', dataIndex: 'minBargainPrice', width: 120 },
  { title: '已参与', dataIndex: 'participantCount', width: 80 },
