...
import { getSeckillList, deleteSeckill } from '@/api/marketing'
...
const columns = [
  ...
  { title: '秒杀价', dataIndex: 'seckillPrice', width: 120 },
  { title: '原价', dataIndex: 'originalPrice', width: 120 },
  { title: '限量', dataIndex: 'limitCount', width: 80 },
...
function handleAdd() {
  router.push('/marketing/seckill/add')
}

function handleEdit(record: any) {
  router.push('/marketing/seckill/add/' + record.id)
}
